...
<div class="bg-white p-8 rounded-xl shadow w-full max-w-md border border-green-100">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Sign in to the admin panel</p>
    </div>
    ...
    <form id="login-form">
        <div class="mb-6">
            ...
            <input type="email" name="email" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-green-500 focus:ring-2 focus:ring-green-200 focus:outline-none transition-all duration-200" required placeholder="Enter your admin email">
        </div>
        <div class="mb-6">
