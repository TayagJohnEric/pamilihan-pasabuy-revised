...
<div class="bg-white p-8 rounded-xl shadow w-full max-w-md border border-green-100">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Sign in to your rider account</p>
    </div>
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-600 text-sm">
            ...
            <a href="{{ route('rider-applications.create') }}" class="text-green-600 hover:text-green-700 font-semibold">Apply Here</a>
        </p>
    </div>
</div>
