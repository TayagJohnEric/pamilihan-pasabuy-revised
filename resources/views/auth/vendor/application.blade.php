...
<div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-10">
            <div class="mx-auto h-16 w-16 bg-pink-600 rounded-full flex items-center justify-center mb-4">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">Join Our Vendor Network</h1>
            <p class="text-pink-100 text-lg">Apply to become a verified vendor in our marketplace</p>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="form-section px-6 py-4">
                    <h2 class="text-xl font-semibold text-gray-800 flex items-center">
                        <svg class="h-5 w-5 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-8 py-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="applicant_first_name" placeholder="Enter your first name" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Last Name *</label>
                            <input type="text" name="applicant_last_name" placeholder="Enter your last name" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" name="applicant_email" placeholder="your@email.com" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Phone Number *</label>
                            <input type="text" name="applicant_phone_number" placeholder="+63 xxx xxx xxxx" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-8 py-6 space-y-6">
                    <div>
                        ...
                        <input type="text" name="proposed_vendor_name" placeholder="Enter your business/vendor name" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200" required>
                    </div>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Stall Number Preference</label>
                            <input type="text" name="stall_number_preference" placeholder="e.g., A-01, B-15 (Optional)" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="market_section_preference" placeholder="e.g., Food Court, Electronics (Optional)" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200">
                    ...
                    <div>
                        ...
                        <textarea name="business_description" rows="4" placeholder="Describe your business, what you plan to sell, your experience, target customers, etc." class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200 resize-none" required></textarea>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Primary Product Categories *</label>
                        <textarea name="primary_product_categories_description" rows="3" placeholder="List the main categories of products or services you will offer (e.g., Fresh vegetables, Cooked meals, Electronics, Clothing, etc.)" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-pink-500 focus:outline-none transition duration-200 resize-none" required></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="text-center">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <button type="submit" class="px-8 py-3 bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-lg hover:from-pink-700 hover:to-pink-800 transition duration-200 font-medium shadow-lg transform hover:scale-105">
                                Submit Application
                            </button>
                        </div>
        ...
        <!-- Footer -->
        <div class="text-center mt-8 text-pink-100">
        ...
        input.addEventListener('change', function() {
            ...
            if (this.files && this.files.length > 0) {
                if (this.files.length === 1) {
                    ...
                    label.innerHTML = `
                        <span class="text-sm text-pink-600 font-medium">${fileName}</span>
                        <p class="text-xs text-gray-500 mt-1">File size: ${fileSize} MB</p>
                    `;
                } else {
                    label.innerHTML = `
                        <span class="text-sm text-pink-600 font-medium">${this.files.length} files selected</span>
                        <p class="text-xs text-gray-500 mt-1">Multiple files uploaded</p>
                    `;
                }
                fileContainer.classList.add('border-pink-400', 'bg-pink-50');
            }
        });
    });
