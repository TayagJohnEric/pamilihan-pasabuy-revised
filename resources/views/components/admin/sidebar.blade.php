                ...
                <ul class="space-y-2 px-4">
                            ...
                            <div class="dropdown-content ml-8 mt-1">
                                <ul class="space-y-1">
                                    <li><a href="{{ route('admin.payments.index') }}" class="block p-2 text-sm text-gray-600 hover:text-green-500 hover:bg-green-50 rounded-md transition-colors">Payment Transaction</a></li>
                                     <li><a href="{{ route('admin.payouts.dashboard') }}" class="block p-2 text-sm text-gray-600 hover:text-green-500 hover:bg-green-50 rounded-md transition-colors">Payout Dashboard</a></li>
                   ...
                   <li>
                        <div class="dropdown-item">
                            ...
                            <div class="dropdown-content ml-8 mt-1">
                                <ul class="space-y-1">
                                    <li><a href="{{ route('system-settings.index') }}" class="block p-2 text-sm text-gray-600 hover:text-green-500 hover:bg-green-50 rounded-md transition-colors">System Settings</a></li>
