                ...
                <ul class="space-y-2 px-4">
                   ...
                   <li>
                    ...
                    <li>
                      ...
                      <!-- Top Riders -->
                    <li>
                        <a href="{{ route('merit-system.index') }}" class="group flex items-center font-semibold p-3 rounded-lg hover:bg-green-500 hover:text-white transition-all duration-200">
