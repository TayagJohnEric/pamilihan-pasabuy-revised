...
<div class="max-w-[90rem] mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Edit District</h2>
                <p class="text-gray-600">Update the details for {{ $district->name }}</p>
            </div>
        ...
        <form action="{{ route('admin.districts.update', $district) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="relative">
                        <input type="number" 
                               id="distance_km" 
                               name="distance_km" 
                               value="{{ old('distance_km', $district->distance_km) }}"
                               step="0.01"
                               min="0"
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" 
                               id="delivery_fee" 
                               name="delivery_fee" 
                               value="{{ old('delivery_fee', $district->delivery_fee) }}"
                               step="0.01"
                               min="0"
