    ...
    <div class="max-w-[90rem] mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Rider Payouts</h2>
                    <p class="text-gray-600">Manage and process rider delivery fee payouts</p>
                </div>
                ...
                <form method="GET" action="{{ route('admin.payouts.riders') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a href="{{ route('admin.payouts.riders') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">
                                Clear
                            </a>
                        </div>
                    </div>
