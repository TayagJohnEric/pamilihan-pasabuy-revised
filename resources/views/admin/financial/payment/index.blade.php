...
<div class="max-w-[90rem] mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <p class="text-gray-600 mb-6">Manage and filter all payments.</p>
        ...
        <form method="GET" action="{{ route('admin.payments.index') }}" 
            ...
            <!-- Search Field -->
            <div>
                <label class="block text-gray-700 mb-1">Search Rider/Vendor</label>
                <input type="text" 
                       name="search" 
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('admin.payments.index') }}" 
                   class="ml-2 px-4 py-2 border rounded-lg text-gray-600 hover:bg-gray-100">
                    Reset
                </a>
            </div>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-600">Rider</th>
                         <th class="px-4 py-2 text-left text-sm font-semibold text-gray-600">Vendor</th>
