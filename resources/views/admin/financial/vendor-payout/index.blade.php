            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center text-white">
                <div class="mb-6 lg:mb-0">
                    ...
                    <p class="text-emerald-100 text-lg">
                        Manage and process vendor sales payouts
                    </p>
                </div>
                ...
                <form method="GET" action="{{ route('admin.payouts.vendors') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a href="{{ route('admin.payouts.vendors') }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-xl font-medium transition-all duration-200 text-center shadow-md hover:shadow-lg">
                                Clear
                            </a>
                        </div>
                    </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-12 w-12">
                                                ...
                                                @else
                                                    <div class="flex-shrink-0 h-12 w-12 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center shadow-md">
