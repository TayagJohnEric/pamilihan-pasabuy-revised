            ...
            <div class="px-6 py-8 sm:px-8">
                <form method="POST" action="{{ route('customer.password.update') }}" class="space-y-6" novalidate>
                    ...
                    <div class="pt-4">
                       <button 
    type="submit" 
    class="w-full bg-gradient-to-r from-emerald-600 via-emerald-600 to-teal-600 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 hover:from-emerald-700 hover:via-emerald-700 hover:to-teal-700">
