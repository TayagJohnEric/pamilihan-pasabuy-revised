                            ...
                            <div class="flex flex-col lg:flex-row gap-4">
                                ...
                                <div class="flex-grow">
                                    ...
                                    @if($item->product->is_budget_based && !$isBudgetBased)
                                        ...
                                        <div id="budget-conversion-{{ $item->id }}" class="hidden mt-3 p-3 bg-blue-50 rounded-lg" data-item-id="{{ $item->id }}">
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success && response.cart_summary) {
                    ...
                    input.addClass('border-green-300').removeClass('border-red-300');
                    setTimeout(() => input.removeClass('border-green-300'), 2000);
                }
            },
            error: function (xhr) {
