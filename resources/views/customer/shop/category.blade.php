    ...
    <nav class="flex mb-6 text-sm animate-slide-in ">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('products.index') }}" class="text-gray-600 hover:text-green-600">Shop</a>
            </li>
            <li>
...
<div class="relative rounded-lg shadow-lg mb-8 p-6 sm:p-8 text-white animate-slide-in bg-cover bg-center" 
     style="background-image: url('{{ asset('images/bg-banner.png') }}');">
    <div class="absolute inset-0 bg-emerald-800/50 rounded-lg"></div> <!-- Optional overlay for readability -->
