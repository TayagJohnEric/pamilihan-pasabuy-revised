...
class CustomerSavedAddressController extends Controller
{
    public function index()
    {
        ...
        return view('customer.my-account.saved-addresses.index', compact('addresses'));
    }

    public function create()
    {
        $districts = District::where('is_active', true)->orderBy('name')->get();
        return view('customer.my-account.saved-addresses.create', compact('districts'));
    }
    ...
    public function edit(SavedAddress $saved_address)
{
    ...
    $districts = District::where('is_active', true)->orderBy('name')->get();
    return view('customer.my-account.saved-addresses.edit', compact('saved_address', 'districts'));
}
